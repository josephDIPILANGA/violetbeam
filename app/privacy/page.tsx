...
const sectionIcons = [Database, WandSparkles, Sparkles, CreditCard, Lock, ShieldCheck];
    ...
    <main className="min-h-screen bg-[#FDFBFF] text-[#1C1C1C]">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-12 lg:px-10">
        ...
        <section className="grid gap-5">
          {legalCopy.privacySections.map((section, index) => {
        ...
        <section className="mt-8 rounded-[30px] border border-white/75 bg-[#1C1C1C] p-6 text-white shadow-2xl shadow-purple-900/10 md:p-8">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            <div>
              ...
              <h2 className="font-serif text-4xl italic leading-none">{legalCopy.privacyRequests}</h2>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-white/65">
                {legalCopy.privacyContact}
              </p>
            </div>
